document.addEventListener('DOMContentLoaded', function () {
    const colors = ["purple", "white", "blue", "maroon", "#ffcc99","black","lightblue","yellow"]; // Adding more colors
    ...
    colors.forEach(color => {
      ...
      colorOption.addEventListener("click", function() {
        ...
        removeBorderFromAllColorOptions();
    ...
    function removeBorderFromAllColorOptions() {
